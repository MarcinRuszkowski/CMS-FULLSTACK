function EventsCalendarLeft({
  ...
  return (
    <li>
      ...
      <div
        className={`timeline-start timeline-box border-2 border-box-color hover:border-main-color cursor-pointer ${bg}`}
      >
...
export default EventsCalendarLeft;
